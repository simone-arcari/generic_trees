...
/*
	@descr: alloca un puntatore a stack_t (*tail) nell'heap e restituisce il
		puntatore a puntatore a stack_t (**tail)
*/
...
/*
	@descr: inserisco sempre in cima un nodo, è come il normale inserimento
		in testa per le liste
	@param top: sentinella
	@param T: albero da inserire in cima
*/
...
/*
	@descr: estrae l'ultimo elemento inserito nello stack
	@param top: sentinella
*/
	if(top==NULL) {
...
/*
	@descr: alloca un puntatore a queue_t (*head) nell'heap e restituisce il
		puntatore a puntatore a queue_t (**head)
*/
...
/*
	@descr: estrae il primo elemento inserito nella queue
	@param head: sentinella
*/
